    ...
    public JavaFile apply(final UnionShape shape) {
        ...
        shape.getAllMembers().entrySet().forEach(memberEntry -> {
            ...
            FieldSpec.Builder fieldSpecBuilder = PoetryWriter
                    .buildStandardMemberField(memberTypeName, memberName, memberTypeShape);
            final Optional<DeprecatedTrait> deprecatedTrait = memberEntry.getValue().getTrait(DeprecatedTrait.class);
            ...
            final Optional<DocumentationTrait> docTrait = context.getModel().getShape(memberShapeId).get().getTrait(DocumentationTrait.class);
            ...
            //clear prior set member if one is set
            setterBuilder.addCode(CodeBlock.builder()
                    .beginControlFlow("if ($L != null)", UNION_SET_MEMBER_FIELD_NAME)
                    .addStatement("$L.nullify(this)", UNION_SET_MEMBER_FIELD_NAME)
                    .endControlFlow()
                    .build());
            ...
            docTrait.ifPresent(documentationTrait -> setterBuilder.addJavadoc(documentationTrait.getValue()));
            if(deprecatedTrait.isPresent()) {
            ...
            MethodSpec.Builder witherBuilder = MethodSpec.methodBuilder(
                    ...
                    .returns(className);
            docTrait.ifPresent(documentationTrait -> witherBuilder.addJavadoc(documentationTrait.getValue()));
            if(deprecatedTrait.isPresent()) {
